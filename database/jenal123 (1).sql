...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2024 at 12:53 PM
...
(2, 'jenal', '111', 'admin2', '085870283409', 'petugas');
...
('65dc43b7f29c5.png', 'z001', 'novel', 'kisah petualangan harimau', 'desi nurul anggaini', 'Pt.granmedia', '2021-09-12', 38, 'si harimau yang perkasa,di balik tokoh sang harimau,harimau jga ditakuti dari hewan hewan lain', '4_Kisah_Petualangan_Harimau_dan_Hewan_Lainnya nadi.pdf'),
('65dc43a4d60b6.png', 'z002', 'novel', 'Legenda rawa pening', 'Tri wahyuni', 'giet wijaya', '2016-10-30', 63, ' Rawa Pening merupakan daerah rawa yang \r\nmenjadi objek wisata yang menarik di Jawa Tengah. \r\nArea tersebut merupakan ekosistem enceng gondok', 'SMP_Legenda_Rawa_Pening-Sigit-Fiks.pdf'),
('65dc437939536.png', 'z003', 'novel', 'Misteri penunggu pohon tua', 'Aldo Sinatra', 'Suvanna Visakha Wu', '2014-10-30', 136, 'pembabaran Dharma yang lebih santai, menyegarkan, \r\ntidak menggurui, tapi dapat menyentuh pembacanya.', 'misteri.pdf'),
('65dc435b7b26f.png', 'z004', 'novel', 'pajak kita', 'asep sinaga', 'sumirna hidayah', '2014-12-03', 44, ' sama pentingnya dengan nilai-nilai tersebut di atas adalah nilai kemandirian. Betapa perlunya \r\nmenanamkan nilai kemandirian pada anak-anak untuk menumbuhkan sikap kemandirian bangsa \r\nmelalui pajak', 'Buku Cergam Pajak Kita.pdf'),
('65dc433e8ad51.png', 'z005', 'novel', 'kalah oleh si cerdik', 'atisah', 'asep lukman arif hidayat', '2017-10-03', 65, 'kancil yang serakah karna makanan ', '74._Isi_dan_Sampul_Kalah_oleh_Si_Cerdik.pdf'),
('65dc432e9c7e7.png', 'z006', 'novel', 'dongen anak dunia', 'Dedik Dwi Prihatmoko', 'Maura Handaru ', '2019-10-08', 28, 'sang beruang yang menuruti perkataan ibunya', '3.  Lima Dongeng Anak Dunia SQUARE-membaca awal 21x21 28hlm.pdf'),
('65dc4a612b8d2.png', 'z007', 'novel', 'kisah teladan nabi dan rosul', 'pendidikan agama islam', 'budi pekerti', '2011-05-03', 22, 'keteladanan yang patut kita contoh', 'nabi.pdf'),
('65dc4b2d0fcf6.png', 'z008', 'novel', 'pencegahan terhadap anak', 'fredy.H', 'fachrul razi', '2015-03-12', 154, 'pencegahan kekerasan', 'komik-kta.pdf'),
('65dc4bf90566a.png', 'z009', 'novel', 'putri mandalika', 'frida nur cahyani', 'irham yudha pramana', '2018-11-12', 54, 'sang raja yang cemas', 'komik-cerita-putri-mandalika.pdf'),
('65dc4dea05372.jpg', 'z010', 'novel', 'malin kundang', 'tika ikanegara', 'mulia jaya', '2017-10-19', 10, 'anak yang durhaka terhadap orang tua', '98845-ID-malin-kundang-pulang-kampung-karya-ahmad.pdf');
...
(11111, '99', 'jenal', '$2y$10$EfT.x.QxntgdBedt4zc/p.6jGfgrFFlBFwQ..YWrkkXDGhwr40V0m', 'Laki laki', 'XII', 'Rekayasa Perangkat Lunak', '08127182191', '2024-11-02'),
